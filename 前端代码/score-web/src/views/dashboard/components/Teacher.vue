...
import { updateTableDataApi, updateTeaPwdApi, getTeacherInfoApi } from "@/api/teacher"
import { type TeacherData } from "@/api/teacher/types/teacher"
import { useUserStore } from '@/store/modules/user'
import { type FormInstance, type FormRules, ElMessage, ElMessageBox } from "element-plus"
import { cloneDeep } from "lodash-es"

const info: TeacherData = {
  id: undefined,
  teacherId: 0,
  teacherName: "",
  gender: "",
...
const formData = ref<TeacherData>(cloneDeep(info))
...
const handleCreateOrUpdate = () => {
  formRef.value?.validate((valid: boolean, fields) => {
    ...
    const api = formData.value.id === undefined ? updateTableDataApi : updateTeaPwdApi
    api(formData.value)
      .then((res) => {
  ...
  <div class="app-container">
    ...
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        <el-form-item prop="teacherId" label="教师工号">
          <el-input v-model="formData.teacherId" disabled />
        </el-form-item>
        <el-form-item prop="teacherName" label="姓名">
          <el-input v-model="formData.teacherName" placeholder="请输入" disabled/>
        </el-form-item>
        ...
        <el-form-item prop="title" label="职称">
          <el-input v-model="formData.title" placeholder="请输入" disabled/>
        </el-form-item>
